...
作用：设备通过节点中转流量，实现科学上网[绕过GFW（即“防火长城”（等设施]。  
...
###### 极低的投入带来了较差的体验（对于本段大部分来说），高ping，低带宽，以及消失的安全性。
