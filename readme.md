...
##### 此背景下，本项诞生了，意在帮助一些新手一站式学习翻墙工具、方法，及注意事项。下文从四个”角色“所对应方法进行简述
...
#### 1. 什么是节点？   
节点 = 一个具体的代理服务器（也叫“服务器”或“Proxy”）。它包含：服务器IP地址、端口、协议类型（VMess、VLESS、Trojan、Shadowsocks等）、密码/UUID、加密方式等信息。   
作用：你的设备通过这个“节点”中转流量，实现科学上网（绕过网络限制）。  
一个好的节点通常有低延迟、高速度、解锁Netflix/YouTube等流媒体的能力。  
单个节点容易被封或负载高，所以大家一般会用很多节点一起用。   
...
#### 项目推荐[NekoBox for Android](https://github.com/MatsuriDayo/NekoBoxForAndroid/releases "NekoBox for Android"),  [v2rayN(电脑端的)](https://github.com/2dust/v2rayN/releases "v2rayN")， [Clash Verge(电脑端的)]([](https://github.com/clash-verge-rev/clash-verge-rev/releases) "Clash Verge")
...
*相信够用，不多介绍*  
3.气讨去吧：本段内录优解子）、、在公开媒、体之付如X。（衣任注国内干台
①.联系友发出请求，“伙队用”月
四爱折腾的公于”他什么也不了，合盖了一中所此外还能通
Vps云服务器，关体服务器 搭对专节点）Ghb上已有多一
部置代理服务的脚本海
（惜作者没有轻验）] 
五；“不爱腾似公子”
